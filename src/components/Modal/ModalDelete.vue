<template>
  <Teleport to="body">
    <div
      v-if="isOpen"
      class="bg-[#36445c4d] fixed h-full w-full top-0 right-0 left-0 flex justify-center items-center z-[999]"
    >
      <div class="bg-white p-6 rounded-xl w-[900px]">
        ...
        <div class="flex justify-end mt-3 gap-3">
          ...
          <button
            @click="handleDelete"
            class="bg-[#dc3545] hover:bg-[#dc3546bb] w-[100px] text-white rounded-md flex justify-center items-center"
          >
            Xóa
          </button>
        </div>
